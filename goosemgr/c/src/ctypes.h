...
#define VEN_IED1_MAC_ADDRESS_VALUE {0x08, 0x00, 0x27, 0x01, 0x01, 0x34}
#define VEN_IED2_MAC_ADDRESS_VALUE {0x08, 0x00, 0x27, 0x01, 0x01, 0x35}
#define VEN_IED3_MAC_ADDRESS_VALUE {0x08, 0x00, 0x27, 0x01, 0x01, 0x36}    
...
#define CTYPE_TIMESTAMP		long long  //timestamp in GOOSE takes 8 bytes, first 4 bytes are integer second from 1970, following 3 byte are fractional seconds, last 1 byte is quality
                                           // ssss ssss ssss ssss ssss ssss ssss ssss  ffff ffff ffff ffff fffff ffff qqqq qqqq
...
extern unsigned char VEN_IED1_MAC_ADDRESS[];
extern unsigned char VEN_IED2_MAC_ADDRESS[];
extern unsigned char VEN_IED3_MAC_ADDRESS[]; 
