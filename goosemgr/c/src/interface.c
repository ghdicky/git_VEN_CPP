...
//include mysqlwrapper.h to call C++ db
...
int readPacket() {
	return pcap_loop(fp, -1, packet_handler_interface, NULL); // -1 or other negative value means to sniff until an error occurs
}
