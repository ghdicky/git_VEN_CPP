...
void init_datatypes() {
	...
	init_mySPS(&D1Q1SB4.S1.C1.RSYNa_1.Rel);
        ...
        //initialise value of GGIO_1.AnIn.mag.f and GGIO_2.AnIn.mag.f for SendVENIED1
        //init_myAnalogValue(&SendVENIED1.P1.C1.GGIO_1_21P.AnIn.mag);
        //init_myAnalogValue(&SendVENIED1.P1.C1.GGIO_2_21Q.AnIn.mag);
        
        //initialise value of GGIO_1.AnIn.mag.f and GGIO_2.AnIn.mag.f for SendVENIED2
        //init_myAnalogValue(&SendVENIED2.P1.C1.GGIO_1_53P.AnIn.mag);
        //init_myAnalogValue(&SendVENIED2.P1.C1.GGIO_2_53Q.AnIn.mag);
